...
# teste matriz adjacente
#print()
#print()
#adj = adjacencyMatrix(loadGraph())
#adj.printMatrix()
#adj.addVertex("A")
#adj.editEdge(["A", "2"], True)
#adj.editEdge(["A", "4"], True)
#adj.printMatrix()
#print() 
#adj.printMatrix()
#print(adj.vertexNeighbours("2"))
#print(adj.vertexNeighbours("A"))

#teste lista adjacente

#print()
#print()
#adj = adjacencyList(loadGraph(fileName))
#adj.printList()
#print("teste1")
##adj.addVertex("A")
#adj.addEdge(["A", "2"])
